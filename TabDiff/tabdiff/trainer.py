...
class Trainer:
    ...
    def report_test(self, num_runs):
        ...
        for i in range(num_runs):
            ...
            shape_.append(out_metrics.get("density/Shape", np.nan))
            trend_.append(out_metrics.get("density/Trend", np.nan))
            mle_.append(out_metrics.get("mle", np.nan))   # mle may be disabled
            c2st_.append(out_metrics.get("c2st", np.nan))
